...
const loadStore = async () => {
	...
	await vi.doMock('$lib/logic/api-client/tags/tags', () => ({
		getTagDetails: vi.fn(async (name: string) => ({ name, count: 5, type: 'artist' }))
	}));
	return await import('./active-tags-store');
};
